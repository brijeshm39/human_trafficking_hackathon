	...
	<div class="grid-container">
		...
		<div class="hero-holder grid-70 mobile-grid-100 tablet-grid-100">
			<div class="hero-inner">
				...
				<h1 class="hero-title">Gallery of <span>Truth</span></h1>
...
<div class="grid-container">
	...
	<section id="portfolio-section" class="portfolio-section about-section content-section" data-animate-up="ha-header-hide" data-animate-down="ha-header-small">
		<div class="grid-container">
